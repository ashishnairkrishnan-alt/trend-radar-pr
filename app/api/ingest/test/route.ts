...
const MOCK_RAW_TRENDS: Omit<RawTrend, 'id' | 'created_at' | 'processed'>[] = [
  ...
  {
    platform: 'tiktok',
    trend_name: '#RiyadhBrunch',
    trend_type: 'hashtag',
    emotional_hook: 'Saudi Friday brunch culture — upscale, social, celebratory',
    engagement_volume: 5_600_000,
    spike_pct: 310,
    raw_data: { source: 'mock', cluster: 'mena' },
  },
  {
